...
;对于置顶最好用快捷键来的更准确一点 Win+A(AlwaysTop)，定义到a字母上是为了好按
...
#IfWinActive ahk_class TXGuiFoundation
{
	...
	;快速到QQ接收的文件目录，请自己修改对应目录
	!f::run,"%COMMANDER_PATH%\totalcmd.EXE" /T /O /S /L="D:\My Documents\Tencent Files\你的qq号码\FileRecv\"
}
